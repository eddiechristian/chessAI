                        ...
                        previous_player_move: &Vec<&str>) {
        {
            ...
            match self.piece_type {
                ...
                PieceType::BLACK_PAWN => {
                    if let Some(moves_that_enable_en_passant_vec) = en_passant_map.get(&piece_coord[..]) {
                        ...
                        if moves_that_enable_en_passant_vec.contains(&&last_move[..]) {
                            ...
                            let en_passant_move = format!("en-passant{}{}-{}",
                                    ...
                                    match  self.piece_type {
                                        PieceType::BLACK_PAWN => '6',
                                        PieceType::WHITE_PAWN => '3',
                                        _ => ' '
                                    },
                                    previous_player_move[1],
                                    );
                    ...
                    if self.piece_type == PieceType::BLACK_PAWN {
                        let chess_moves = vec![
                ...
                PieceType::BLACK_ROOK => {
                    self.allowed_moves = rook::get_rook_moves(&state, piece_coord.into_bytes());
                },
...
//"D5-en-passantC6-C5"
        ...
        self.player_turn = {
            match self.player_turn {
                PlayerColor::WHITE => {
                    self.state.player_turn = PlayerColor::BLACK;
                    PlayerColor::BLACK
                }
                    ,
                PlayerColor::BLACK => {
                    self.state.player_turn = PlayerColor::WHITE;
                    PlayerColor::WHITE
                }
            }
        };
    ...
    pub fn new()-> Game  {
        ...
        let black_rook1 = Piece {
            piece_type: PieceType::BLACK_ROOK,
            piece_value: game_state::get_piece_integer(PieceType::BLACK_ROOK),
            current_coord: "A1".to_string(),
            allowed_moves: Vec::new(),
        };
        state_map.insert("A1".to_string(),"BLACK_ROOK1".to_string());

        let black_rook2 = Piece {
            piece_type: PieceType::BLACK_ROOK,
            piece_value: game_state::get_piece_integer(PieceType::BLACK_ROOK),
            current_coord: "H1".to_string(),
            allowed_moves: Vec::new(),
        };
        state_map.insert("H1".to_string(),"BLACK_ROOK2".to_string());

        let black_knight1 = Piece {
            piece_type: PieceType::BLACK_KNIGHT,
            piece_value: game_state::get_piece_integer(PieceType::BLACK_KNIGHT),
            current_coord: "B1".to_string(),
            allowed_moves: vec!["C3".to_string(), "A3".to_string()],
        };
        state_map.insert("B1".to_string(),"BLACK_KNIGHT1".to_string());
        ...
        state_map.insert("G1".to_string(),"BLACK_KNIGHT2".to_string());

        let black_bishop1 = Piece {
            piece_type: PieceType::BLACK_BISHOP,
            piece_value: game_state::get_piece_integer(PieceType::BLACK_BISHOP),
            current_coord: "C1".to_string(),
            allowed_moves: Vec::new(),
        };
        state_map.insert("C1".to_string(),"BLACK_BISHOP1".to_string());

        let black_bishop2 = Piece {
            piece_type: PieceType::BLACK_BISHOP,
            piece_value: game_state::get_piece_integer(PieceType::BLACK_BISHOP),
            current_coord: "F1".to_string(),
            allowed_moves: Vec::new(),
        };
        state_map.insert("F1".to_string(),"BLACK_BISHOP2".to_string());

        let black_queen = Piece {
            piece_type: PieceType::BLACK_QUEEN,
            piece_value: game_state::get_piece_integer(PieceType::BLACK_QUEEN),
        ...
        state_map.insert("A2".to_string(),"BLACK_PAWN1".to_string());
        //
        ...
        state_map.insert("B2".to_string(),"BLACK_PAWN2".to_string());
        ...
        state_map.insert("C2".to_string(),"BLACK_PAWN3".to_string());
        ...
        state_map.insert("D2".to_string(),"BLACK_PAWN4".to_string());
        ...
        state_map.insert("E2".to_string(),"BLACK_PAWN5".to_string());
        ...
        state_map.insert("F2".to_string(),"BLACK_PAWN6".to_string());
        ...
        state_map.insert("G2".to_string(),"BLACK_PAWN7".to_string());
        ...
        state_map.insert("H2".to_string(),"BLACK_PAWN8".to_string());

        black_pieces.insert("BLACK_ROOK1".to_string(), Box::new(black_rook1));
        ...
        state_map.insert("A7".to_string(),"WHITE_PAWN1".to_string());
        ...
        state_map.insert("B7".to_string(),"WHITE_PAWN2".to_string());
        ...
        state_map.insert("C7".to_string(),"WHITE_PAWN3".to_string());
        ...
        state_map.insert("D7".to_string(),"WHITE_PAWN4".to_string());
        ...
        state_map.insert("E7".to_string(),"WHITE_PAWN5".to_string());
        ...
        state_map.insert("F7".to_string(),"WHITE_PAWN6".to_string());
        ...
        state_map.insert("G7".to_string(),"WHITE_PAWN7".to_string());
        ...
        state_map.insert("H7".to_string(),"WHITE_PAWN8".to_string());
        ...
        let white_bishop1 = Piece {
            ...
            current_coord: "C8".to_string(),
            allowed_moves: Vec::new(),
        };
        state_map.insert("C8".to_string(),"WHITE_BISHOP1".to_string());

        let white_bishop2 = Piece {
            piece_type: PieceType::WHITE_BISHOP,
            piece_value: game_state::get_piece_integer(PieceType::WHITE_BISHOP),
            current_coord: "F8".to_string(),
            allowed_moves: Vec::new(),
        };
        state_map.insert("F8".to_string(),"WHITE_BISHOP2".to_string());

        let white_rook1 = Piece {
            piece_type: PieceType::WHITE_ROOK,
            piece_value: game_state::get_piece_integer(PieceType::WHITE_ROOK),
            current_coord: "A8".to_string(),
            allowed_moves: Vec::new(),
        };
        state_map.insert("A8".to_string(),"WHITE_ROOK1".to_string());

        let white_rook2 = Piece {
            piece_type: PieceType::WHITE_ROOK,
            piece_value: game_state::get_piece_integer(PieceType::WHITE_ROOK),
            current_coord: "H8".to_string(),
            allowed_moves: Vec::new(),
        };
        state_map.insert("H8".to_string(),"WHITE_ROOK2".to_string());

        let white_queen = Piece {
            piece_type: PieceType::WHITE_QUEEN,
            piece_value: game_state::get_piece_integer(PieceType::WHITE_QUEEN),
            current_coord: "D8".to_string(),
            allowed_moves: Vec::new(),
        };
